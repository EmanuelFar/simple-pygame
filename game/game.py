...
player_idx = 0
player_rect = player_anim_list[int(player_idx)].get_rect(topleft = (50,320))
...
bluefly_rect = bluefly_anim_lst[bluefly_idx].get_rect(topright = (bluefly_pos,280))
...
fly_idx = 0
fly_pos = 1200
fly_rect = fly_anim_lst[fly_idx].get_rect(topright = (fly_pos,280))
